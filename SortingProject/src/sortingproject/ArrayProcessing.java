...
public class ArrayProcessing {
    ...
    //Mengurutkan data aarray secara ascending
   int[] urutkan(int[] dataBil){
    ...
    void output(){
        ...
        System.out.println("Data setelah di urutkan secara Ascending: " + Arrays.toString(this.urutkan(dataBil)));
    }
}
